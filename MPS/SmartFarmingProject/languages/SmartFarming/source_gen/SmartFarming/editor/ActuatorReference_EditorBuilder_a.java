...
/*package*/ class ActuatorReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_uxe4rh_a2a()) {
      editorCell.addEditorCell(createConstant_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_uxe4rh_a2a() {
  ...
  private EditorCell createRefCell_0() {
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.Uses$ubjG);
    }
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ",");
    editorCell.setCellId("Constant_uxe4rh_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
