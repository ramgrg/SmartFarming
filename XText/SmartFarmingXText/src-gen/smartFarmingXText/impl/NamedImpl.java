 ...
 * </p>
 * <ul>
 *   <li>{@link smartFarmingXText.impl.NamedImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedImpl extends MinimalEObjectImpl.Container implements Named {
	...
	protected EClass eStaticClass() {
		return SmartFarmingXTextPackage.Literals.NAMED;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartFarmingXTextPackage.NAMED__NAME, oldName, name));
	}
	...
	public boolean MustHaveName(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Named::MustHaveName";
		try {
			/**
			 *
			 * inv MustHaveName:
			 ...
			 *     then true
			 *     else
			 *       let result : Boolean[?] = not name.oclIsUndefined()
			 *       in
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					SmartFarmingXTextPackage.Literals.NAMED___MUST_HAVE_NAME__DIAGNOSTICCHAIN_MAP);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SmartFarmingXTextPackage.NAMED__NAME:
			return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case SmartFarmingXTextPackage.NAMED___MUST_HAVE_NAME__DIAGNOSTICCHAIN_MAP:
